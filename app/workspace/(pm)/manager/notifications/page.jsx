...
import NotificationDetailsModal from "../../../../../components/workspace/pm/notifications/NotificationDetailsModal";
import NotificationCard from "../../../../../components/workspace/pm/notifications/NotificationCard";
import NotificationStats from "../../../../../components/workspace/pm/notifications/NotificationStats";
import NotificationsSkeleton from "../../../../../components/workspace/pm/notifications/NotificationsSkeleton";
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Stay updated with your latest alerts and project updates
              </p>
            </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            ...
            <TabsContent value={activeTab} className="space-y-4">
              {filteredNotifications.length === 0 ? (
                ...
                <ScrollArea className="h-[calc(100vh-380px)] sm:h-[calc(100vh-400px)]">
