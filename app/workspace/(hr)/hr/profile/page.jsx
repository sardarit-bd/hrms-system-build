...
import ChangePasswordDialog from "../../../../../components/workspace/hr/profile/ChangePasswordDialog";
import HRManagerInfoCard from "../../../../../components/workspace/hr/profile/HRManagerInfoCard";
import WorkInfoCard from "../../../../../components/workspace/hr/profile/WorkInfoCard";
import PersonalInfoForm from "../../../../../components/workspace/hr/profile/PersonalInfoForm";
import ProfileHeader from "../../../../../components/workspace/hr/profile/ProfileHeader";
import ProfileSkeleton from "../../../../../components/workspace/hr/profile/ProfileSkeleton";


export default function HRManagerProfilePage() {
          ...
          <Tabs defaultValue="personal" className="space-y-4 sm:space-y-6">
            <div className="overflow-x-auto">
              <TabsList className="inline-flex w-auto min-w-full sm:min-w-0 gap-1">
                ...
                <TabsTrigger value="hr" className="cursor-pointer text-xs sm:text-sm px-3 sm:px-4">
                  HR Info
                </TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="hr" className="space-y-4 sm:space-y-6">
              <HRManagerInfoCard profileData={profileData} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
