...
import HolidayDetailsModal from "../../../../components/workspace/gm/holidays/HolidayDetailsModal";
import UpcomingHolidaysCard from "../../../../components/workspace/gm/holidays/UpcomingHolidaysCard";
import HolidayList from "../../../../components/workspace/gm/holidays/HolidayList";
import HolidayFilters from "../../../../components/workspace/gm/holidays/HolidayFilters";
import HolidayStatsCards from "../../../../components/workspace/gm/holidays/HolidayStatsCards";
import HolidaySkeleton from "../../../../components/workspace/gm/holidays/HolidaySkeleton";
import HolidayCalendar from "../../../../components/workspace/gm/holidays/HolidayCalendar";


export default function GMHolidaysPage() {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Company-wide holiday calendar and observances
              </p>
            </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            <div className="overflow-x-auto">
              <TabsList className="inline-flex w-auto min-w-full sm:min-w-0 gap-1">
                ...
                <TabsTrigger value="calendar" className="cursor-pointer text-xs sm:text-sm px-3 sm:px-4">
                  Calendar
                </TabsTrigger>
              </TabsList>
            </div>
