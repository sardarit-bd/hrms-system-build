...
import NotificationDetailsModal from "../../../../components/workspace/gm/notifications/NotificationDetailsModal";
import NotificationCard from "../../../../components/workspace/gm/notifications/NotificationCard";
import NotificationFilters from "../../../../components/workspace/gm/notifications/NotificationFilters";
import NotificationStats from "../../../../components/workspace/gm/notifications/NotificationStats";
import NotificationsSkeleton from "../../../../components/workspace/gm/notifications/NotificationsSkeleton";


export default function GMNotificationsPage() {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Stay updated with company-wide alerts and executive updates
              </p>
            </div>
