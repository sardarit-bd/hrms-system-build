...
export const getMenuItemsByRole = (role) => {
  ...
  if (role === "hr") {
    return [
      ...
      {
        label: "Roster & Shifts",
        href: "/workspace/hr/roster-shifts",
        icon: Clock3,
      },

      {
        label: "Attendance Policies",
        href: "/workspace/hr/attendance-policies",
        icon: ShieldCheck,
      },
  ...
  if (role === "general_manager" || role === "gm") {
    return [
      {
        label: "Dashboard",
        href: "/workspace/gm/dashboard",
        icon: LayoutDashboard,
      },

      {
        label: "Employees",
        href: "/workspace/gm/employees",
        icon: Users,
      },

      {
        label: "Projects",
        href: "/workspace/gm/projects",
        icon: FolderKanban,
      },

      {
        label: "Leave Approvals",
        href: "/workspace/gm/leave-approvals",
        icon: CalendarClock,
      },

      {
        label: "Payroll",
        href: "/workspace/gm/payroll",
        icon: DollarSign,
      },

      {
        label: "Reports",
        href: "/workspace/gm/reports",
        icon: BarChart3,
      },

      {
        label: "Notifications",
        href: "/workspace/gm/notifications",
        icon: BellRing,
      },

      {
        label: "Holidays",
        href: "/workspace/gm/holidays",
        icon: CalendarDays,
      },

      {
        label: "My Profile",
        href: "/workspace/gm/profile",
        icon: UserCircle,
      },
    ];
  }
