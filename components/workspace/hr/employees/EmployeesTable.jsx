...
import { Eye, Edit, MoreHorizontal, UserCog, CheckCircle, ChevronLeft, ChevronRight, Users } from "lucide-react";
        ...
        <div key={employee.id} className="bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-gray-800 p-3">
          ...
          <div className="flex gap-2 mt-3 pt-2 border-t border-gray-100 dark:border-gray-800">
            ...
            {employee.status === "pending" && (
              <Button
                size="sm"
                onClick={() => onApproveEmployee(employee)}
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-40 sm:w-48">
                    ...
                    >
                      <Edit size={12} className="sm:w-3.5 sm:h-3.5 mr-2" />
                      Edit HR Info
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                    ...
                    >
                      <UserCog size={12} className="sm:w-3.5 sm:h-3.5 mr-2" />
