...
import { Mail, Phone, Briefcase, Building2, Calendar, Shield, User } from "lucide-react";
...
export default function EmployeeDetailsModal({ open, onOpenChange, employee, departments, roles }) {
      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <DialogTitle className="text-base sm:text-lg">{employee.full_name}</DialogTitle>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm">{employee.designation || "—"}</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm">{employee.joining_date || "—"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Briefcase size={14} className="text-gray-500" />
              <span className="text-xs text-gray-600 dark:text-gray-400">Employee Code</span>
            </div>
            <span className="text-xs font-mono">{employee.employee_code || "—"}</span>
          </div>
          ...
          {employee.created_at && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs">{new Date(employee.created_at).toLocaleDateString()}</span>
            </div>
          )}
        </div>
      </DialogContent>
