...
export default function NotificationsCard({ notifications, unreadCount }) {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Link href="/workspace/gm/notifications" className="text-xs text-[#C9A84C] hover:text-[#C9A84C]/80 cursor-pointer">
          View All
        </Link>
      </CardHeader>
