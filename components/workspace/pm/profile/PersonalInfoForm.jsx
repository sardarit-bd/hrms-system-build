      ...
      <CardContent className="space-y-4 sm:space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="space-y-1 sm:space-y-2">
            <Label htmlFor="full_name" className="flex items-center gap-2 text-xs sm:text-sm">
              <User size={12} className="sm:w-3.5 sm:h-3.5 text-gray-500" />
              Full Name
            </Label>
            {isEditing ? (
              <>
                <Input id="full_name" {...register("full_name")} className="cursor-text text-sm" />
                {errors.full_name && (
                  <p className="text-xs text-red-500">{errors.full_name.message}</p>
                )}
              </>
            ) : (
              <p className="text-sm sm:text-base text-gray-900 dark:text-white py-2">
          ...
          <div className="space-y-1 sm:space-y-2">
            <Label htmlFor="email" className="flex items-center gap-2 text-xs sm:text-sm">
              <Mail size={12} className="sm:w-3.5 sm:h-3.5 text-gray-500" />
              Email Address
            </Label>
            {isEditing ? (
              <>
                <Input id="email" type="email" {...register("email")} className="cursor-text text-sm" />
                {errors.email && (
          ...
          <div className="space-y-1 sm:space-y-2">
            <Label htmlFor="phone" className="flex items-center gap-2 text-xs sm:text-sm">
              <Phone size={12} className="sm:w-3.5 sm:h-3.5 text-gray-500" />
              Phone Number
            </Label>
            {isEditing ? (
              <>
                <Input id="phone" {...register("phone")} placeholder="Not provided" className="cursor-text text-sm" />
                {errors.phone && (
          ...
          <div className="space-y-1 sm:space-y-2">
            <Label htmlFor="designation" className="flex items-center gap-2 text-xs sm:text-sm">
              <Briefcase size={12} className="sm:w-3.5 sm:h-3.5 text-gray-500" />
              Designation
            </Label>
            {isEditing ? (
              <>
                <Input id="designation" {...register("designation")} placeholder="Not set" className="cursor-text text-sm" />
                {errors.designation && (
