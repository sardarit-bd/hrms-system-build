...
export default function LeaveRequestsTable({ leaveRequests, onViewDetails, onApprove, onReject }) {
    ...
    return (
      <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-12 text-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-gray-400">All leave requests have been reviewed.</p>
        </div>
      </div>
    );
  }
